...
`;
hint.innerHTML = 'Click anywhere to start<br><span style="font-size: 1rem;"> audio visualizer</span>';
...
const fragmentShader = `
 ...
 `;
// ======== UNIFORMS (Color LUT - Jet Colormap) ==========
